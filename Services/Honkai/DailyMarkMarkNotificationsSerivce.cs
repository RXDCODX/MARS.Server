            ...
            try
            {
                ...
                if (dbContext.TelegramUsers.Any())
                {
                    var copy = await dbContext
                        .TelegramUsers.Where(e =>
                            e.HonkaiNotifications || e.ZenlessZoneZeroDailyNotif
                        )
                    ...
                    foreach (var user in copy)
                        ...
                        )
                        {
                            ...
                            )
                            {
                                ...
                                user is
                                { HonkaiNotifications: true, ZenlessZoneZeroDailyNotif: true }
                            )
                            {
                                const string query3 = """
