...
- `ActualizeFollowersAsync()` - актуализация данных (удаление отписавшихся, обновление статусов)
...
2. **Актуализация при запуске** - автоматическое сравнение с текущим состоянием API, удаление отписавшихся, обновление статусов
3. **При получении WebSocket событий** - автоматическое обновление БД
4. **При вызове `RefreshFollowersCacheAsync()`** - принудительное обновление
5. **При вызове `ActualizeFollowersAsync()`** - ручная актуализация данных
6. **При успешном API запросе** - обновление БД актуальными данными
...
// Актуализация данных (удаление отписавшихся, обновление статусов)
...
- **Автоматическая актуализация** - при запуске приложения автоматически синхронизируются данные с API
...
- Отписавшиеся пользователи автоматически удаляются из БД при актуализации
