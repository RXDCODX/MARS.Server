...
namespace MARS.Server.Migrations
{
    ...
    [Migration("20260908212451_AddIsAutoHelloEnabled")]
    partial class AddIsAutoHelloEnabled
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MARS.Server.ApplicationState.RootState", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Name = "SevenTvProxyUrl",
                            Description = "Прокси для 7TV API: http://user:pass@host:port или socks5://user:pass@host:port",
                            TypeDescription = "string",
                            Value = ""
                        });
                });

            modelBuilder.Entity("MARS.Server.Services.Adhd.Entities.AdhdLayoutConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("DvdLogosCount")
                        .HasColumnType("integer");

                    b.Property<bool>("ShowBreakingNews")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowCatisa")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowDVDLogos")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowFitnessVideo")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowGTAVideo")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowHydraulicMobileVideo")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowLOFIGirl")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowMukbangVideo")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("ShowRainEffect")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowSlimeVideo")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowStreamerVideo")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShowSurfer")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("AdhdLayoutConfig", (string)null);
                });

            modelBuilder.Entity("MARS.Server.Services.BooruAutoPost.Entities.BooruAutoPostConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BooruAutoPostConfigs");
                });

            modelBuilder.Entity("MARS.Server.Services.BooruAutoPost.Entities.BooruScheduledPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BooruScheduledPosts");
                });

            modelBuilder.Entity("MARS.Server.Services.BooruShared.Entities.PostedImageRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Source", "ImageId", "DiscordChannelId")
                        .IsUnique();

                    b.ToTable("PostedImageRecords");
                });
            ...
            modelBuilder.Entity("MARS.Server.Services.WaifuRoll.Entitys.Husband", b =>
                {
                    ...
                    b.Property<bool>("IsAutoHelloEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MARS.Server.Services.BooruAutoPost.Entities.BooruScheduledPost", b =>
                {
                    b.HasOne("MARS.Server.Services.BooruAutoPost.Entities.BooruAutoPostConfig", "Config")
                        .WithMany()
