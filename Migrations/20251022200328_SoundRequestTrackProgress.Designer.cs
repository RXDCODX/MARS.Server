...
namespace MARS.Server.Migrations
{
    ...
    [Migration("20251022200328_SoundRequestTrackProgress")]
    partial class SoundRequestTrackProgress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MARS.Server.Services.SoundRequest.Entities.PlayerState", b =>
                {
                    b.HasOne("MARS.Server.Services.SoundRequest.Entities.BaseTrackInfo", "CurrentTrack")
                        .WithOne()
                        .HasForeignKey("MARS.Server.Services.SoundRequest.Entities.PlayerState", "CurrentTrackId")
                    ...
                    b.HasOne("MARS.Server.Services.SoundRequest.Entities.BaseTrackInfo", "NextTrack")
                        .WithOne()
                        .HasForeignKey("MARS.Server.Services.SoundRequest.Entities.PlayerState", "NextTrackId")
                        .OnDelete(DeleteBehavior.Restrict);
