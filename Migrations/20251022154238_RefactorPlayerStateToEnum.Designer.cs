...
namespace MARS.Server.Migrations
{
    ...
    [Migration("20251022154238_RefactorPlayerStateToEnum")]
    partial class RefactorPlayerStateToEnum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MARS.Server.Services.SoundRequest.Entities.PlayerState", b =>
                {
                    ...
                    b.Property<Guid?>("CurrentTrackId1")
                        .HasColumnType("uuid");

                    b.Property<string>("CurrentTrackRequestedBy")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("CurrentTrackId1");

                    b.HasIndex("CurrentTrackRequestedBy");

                    b.HasIndex("NextTrackId");

                    b.HasIndex("NextTrackId1");
            ...
            modelBuilder.Entity("MARS.Server.Services.SoundRequest.Entities.PlayerState", b =>
                {
                    ...
                    b.HasOne("MARS.Server.Services.SoundRequest.Entities.BaseTrackInfo", "CurrentTrack")
                        .WithMany()
                        .HasForeignKey("CurrentTrackId1")
                    ...
                    b.HasOne("MARS.Server.Services.SoundRequest.Entities.BaseTrackInfo", "NextTrack")
                        .WithMany()
                        .HasForeignKey("NextTrackId1")
                        .HasConstraintName("FK_SoundRequestPlayerState_SoundRequestBaseTrackInfos_NextTra~1");
