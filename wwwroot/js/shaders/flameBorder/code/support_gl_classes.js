...
class Transform
{
    ...
    get_transfrom()
    {
        if(this.is_need_update)
        {
            ...
            vec3.negate(to_pivot, vec3.fromValues(this.pivot[0], this.pivot[1], 0.0));
            //let from_pivot = vec3.fromValues(this.pivot[0], this.pivot[1], 0.0);

            mat4.translate(this.model, this.model, this.position);
            //mat4.translate(this.model, this.model, from_pivot);
...
class Rect_with_hole
{
    ...
    draw(gl, shader) 
    {
        ...
        gl.drawArrays(gl.TRIANGLES, 0, this.vertices_count / 2);

        //gl.drawArrays(gl.TRIANGLE_STRIP, 0, this.vertices_count / 2);
    
        //gl.drawArrays(gl.POINTS, 0, this.vertices_count / 2);
